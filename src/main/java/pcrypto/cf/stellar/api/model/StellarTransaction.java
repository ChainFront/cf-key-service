...
public class StellarTransaction
{
    ...
    @ApiModelProperty( value = "The transaction status.",
                       ...
                       accessMode = ApiModelProperty.AccessMode.READ_ONLY,
                       readOnly = true )
    private StellarTransactionStatus status = null;
    ...
    @ApiModelProperty( value = "The Stellar transaction id.",
                       position = 100,
                       accessMode = ApiModelProperty.AccessMode.READ_ONLY,
                       readOnly = true )
    ...
    @ApiModelProperty( value = "The Stellar address of the source account for this transaction.",
                       position = 120,
                       accessMode = ApiModelProperty.AccessMode.READ_ONLY,
                       readOnly = true )
    ...
    @ApiModelProperty( value = "The signed XDR encoded transaction.",
                       position = 200,
                       accessMode = ApiModelProperty.AccessMode.READ_ONLY,
                       readOnly = true )
    ...
    public StellarTransactionStatus getStatus()
    {
        return status;
    }

    public void setStatus( final StellarTransactionStatus status )
    {
        this.status = status;
    }
