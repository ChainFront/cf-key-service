...
public class StellarPaymentRequest
{
    ...
    @ApiModelProperty( example = "native",
                       required = true,
                       value = "The code of the asset to use. For XLM, use 'native'. For custom assets, the assetIssuer field " +
                               "is also required.",
                       position = 40 )
    private String assetCode = null;

    @ApiModelProperty( value = "The Stellar address of the issuer of the custom asset. This is only required when using non-native " +
                               "assets.",
                       position = 50 )
