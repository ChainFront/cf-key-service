...
@Entity
@Table( name = "ripple_transaction_request" )
public class RippleTransactionRequestDomain
      extends AbstractAuditableDomain
{
    ...
    private String ripplePaymentRequest;
    ...
    @OneToMany( mappedBy = "rippleTransactionRequest",
                cascade = CascadeType.ALL )
    private List<RippleTransactionRequestApproverDomain> approverDomains;
}
